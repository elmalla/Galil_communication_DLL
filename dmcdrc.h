...
typedef struct _DMCCFAXISINFO
{
	...
	USHORT		Reserved1;
	LONG		UserVar;
} DMCCFAXISINFO, FAR* PDMCCFAXISINFO;
...
typedef struct _DMCCFDATARECORD
{
	USHORT		SampleNumber;
	UCHAR		Input0;
	UCHAR		Input1;
	...
	SHORT		AnalogOut6;
	SHORT		AnalogOut7;
	UCHAR		EthernetStatusByte0;
	UCHAR		EthernetStatusByte1;
	UCHAR		EthernetStatusByte2;
	UCHAR		EthernetStatusByte3;
	UCHAR		EthernetStatusByte4;
	UCHAR		EthernetStatusByte5;
	UCHAR		EthernetStatusByte6;
	UCHAR		EthernetStatusByte7;
	UCHAR		ErrorCode;
	UCHAR		ThreadStatus;
	UCHAR		AmpStatReserved1;
	UCHAR		AmpStatReserved2;
	UCHAR		AmpStatReserved3;
	UCHAR		AmpStatReserved4;
	...
	USHORT		CoordinatedMoveStatusT;
	LONG		CoordinatedMoveDistanceT;
	USHORT		BufferSpaceT;
	DMCCFAXISINFO	AxisInfo[8];            // One DMCAXISINFO struct for each axis
} DMCCFDATARECORD, FAR* PDMCCFDATARECORD;
...
typedef struct _DMCCFDATARECORDQR
{
	USHORT fSAxis    :1;                // Contains Axis S info
	USHORT fTAxis    :1;                // Contains Axis T info
	USHORT fIO       :1;                // Contains I/O info
